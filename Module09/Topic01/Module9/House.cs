...
namespace Module9
{
    public class House
    {
        ...
        private Address _address;  // some confusion for me on naming convention, it appears some of the video conflict some of what is written hince my confusion
        ...
        public House(int addressNumber, string addressStreet, string addressAptNum, string city, string state, int zipcode) // default no-arg
        {
            ...
            _address = new Address(addressNumber, addressStreet, addressAptNum, city, state, zipcode);
            NumberBedrooms = 0;
            NumberBathrooms = 0;
        }
        ...
        public override string ToString()
        {
            ...
            return ("House at " + _address.ToString() + " has " + NumberBedrooms + " bedrooms and " + NumberBathrooms + " bathrooms.");
        }
    }
}
